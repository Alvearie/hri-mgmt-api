...
func TestNewHandler(t *testing.T) {
	...
	assert.NotNil(t, handler.jwtBatchValidator)
...
func TestNewHandlerNoAuthFunctions(t *testing.T) {
	...
	handler := NewHandler(config).(*theHandler)
	assert.Equal(t, config, handler.config)
	assert.Nil(t, handler.jwtBatchValidator)

	assert.Equal(t, reflect.ValueOf(CreateBatchNoAuth), reflect.ValueOf(handler.createBatch))
	assert.Equal(t, reflect.ValueOf(CreateBatchNoAuth), reflect.ValueOf(handler.getBatch))
	assert.Equal(t, reflect.ValueOf(GetByBatchIdNoAuth), reflect.ValueOf(handler.getByBatchId))

	assert.Equal(t, reflect.ValueOf(SendStatusCompleteNoAuth), reflect.ValueOf(handler.sendStatusComplete))
	assert.Equal(t, reflect.ValueOf(TerminateBatchNoAuth), reflect.ValueOf(handler.terminateBatch))
	// assert.Equal(t, reflect.ValueOf(ProcessingCompleteNoAuth), reflect.ValueOf(handler.processingCompleteBatch))
	assert.Equal(t, reflect.ValueOf(SendFailNoAuth), reflect.ValueOf(handler.sendFail))
}
