...
import (
	...
	"ibm.com/watson/health/foundation/hri/batches"
	...
	"ibm.com/watson/health/foundation/hri/healthcheck"
	"ibm.com/watson/health/foundation/hri/streams"
	"ibm.com/watson/health/foundation/hri/tenants"
	"net/http"
	"os"
)
